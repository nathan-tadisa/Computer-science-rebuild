        ...
        <div className="grid grid-cols-12 gap-8 items-center">
          ...
          <div className="col-span-12 lg:col-span-7 text-white">
            ...
            <h1 className="text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight mb-6">
              Alumni
              <br />
              <span className="text-[#CAA258]">Community</span>
            </h1>
            
            <p className="text-xl text-white/90 mb-8 max-w-xl font-medium leading-relaxed">
              Celebrate the legacy of the Stellenbosch University Computer Science department. Our alumni network spans decades of pioneering research, distinguished faculty, and graduates who have gone on to shape the global technology landscape.
            </p>
          </div>
          ...
          <div className="col-span-12 lg:col-span-5 relative">
            <div className="bg-white/95 backdrop-blur-sm p-8">
              <p className="text-lg font-bold text-[#61223B] mb-3">Since 1972</p>
              <p className="text-sm text-[#4D5356] font-medium">
                Decades of excellence in computer science
              </p>
            </div>
          </div>
        </div>
